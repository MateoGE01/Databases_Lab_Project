...
def clean_data(datacsv):
    ...
    data = pd.read_csv('Dataset/Courses.csv')
    ...
    data_clean_unique.to_csv('Dataset/CourClean.csv', index=False)

#clean_data('Dataset/Courses.csv')
...
#change_datatype('Dataset/CourClean.csv', 'YoB', 'nevents', 'ndays_act', 'nplay_video', 'nchapters', 'nforum_posts', 'incomplete_flag')